...
## Why it matters
Support costs can be a meaningful part of COGS, especially for enterprise or complex products. If you ignore them,
gross margin and payback targets will look better than reality.

## Pricing implications
If support scales with customer count, include a per-account allocation in fixed overhead. If support scales with usage,
include a per-unit component or premium support tier.
